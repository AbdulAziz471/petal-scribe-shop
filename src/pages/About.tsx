    ...
    <main className="container mx-auto py-10">
      ...
      <section className="mt-8 grid gap-8 md:grid-cols-2 items-center">
        <article>
          ...
          <p className="text-muted-foreground">Born from a lifelong passion for florals, Gifted And Co began with a simple idea: flowers should feel effortless. Our artisans curate gentle palettes—soft blushes, airy whites, fresh greens—to create arrangements that soothe and delight.</p>
      ...
      <section className="mt-10 grid gap-6 md:grid-cols-3">
        ...
        <div className="rounded-md border p-5">
          ...
          <p className="text-sm text-muted-foreground mt-1">Gifted And Co was founded by friends who believe in everyday beauty and mindful gifting.</p>
        </div>
        <div className="rounded-md border p-5">
