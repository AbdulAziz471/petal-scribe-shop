  ...
  return (
    <footer className="border-t mt-16">
      <div className="container mx-auto py-10 grid gap-6 md:grid-cols-3">
        <div>
          <h3 className="font-serif text-lg mb-2">Blossom & Bloom</h3>
      ...
      <div className="container mx-auto pb-8 text-xs text-muted-foreground">© {new Date().getFullYear()} Blossom & Bloom. All rights reserved.</div>
    </footer>
  );
}
